    ...
    <aside className="w-64 bg-white border-r border-gray-200 hidden md:flex flex-col h-full shrink-0 shadow-sm z-10">
      ...
      <div className="flex-1 overflow-y-auto py-4">
        <nav className="px-3 space-y-1">
          ...
          {/* Service Matrix - For Distributors and above */}
          {canManageUsers && (
            <NavLink to="/admin/service-matrix" className={({ isActive }) => `flex items-center px-3 py-2.5 font-medium rounded-md ${isActive ? 'bg-gray-100 text-blue-600' : 'text-gray-700 hover:bg-gray-50'}`}>
              <Shield className="w-5 h-5 mr-3" />
              <span className="font-semibold">Service Activation</span>
            </NavLink>
          )}
          ...
          <div>
            ...
            {openMenus.reports && (
              <div className="pl-11 pr-3 py-1 space-y-1">
                <NavLink to="/admin/ledger" className={({ isActive }) => `block px-3 py-2 text-sm font-medium rounded-md ${isActive ? 'bg-blue-50 text-blue-700' : 'text-gray-600 hover:bg-gray-50 hover:text-black'}`}>• Ledger Statement</NavLink>
                <NavLink to="/admin/pg-add-fund" className={({ isActive }) => `block px-3 py-2 text-sm font-medium rounded-md ${isActive ? 'bg-blue-50 text-blue-700' : 'text-gray-600 hover:bg-gray-50 hover:text-black'}`}>• PG Add Fund History</NavLink>
                ...
                <NavLink to="/admin/bbps-history" className={({ isActive }) => `block px-3 py-2 text-sm font-medium rounded-md ${isActive ? 'bg-blue-50 text-blue-700' : 'text-gray-600 hover:bg-gray-50 hover:text-black'}`}>• BBPS History</NavLink>
                <NavLink to="/admin/fund-requests-history" className={({ isActive }) => `block px-3 py-2 text-sm font-medium rounded-md ${isActive ? 'bg-blue-50 text-blue-700' : 'text-gray-600 hover:bg-gray-50 hover:text-black'}`}>• Fund Requests History</NavLink>
                <NavLink to="/admin/pan-card-history" className={({ isActive }) => `block px-3 py-2 text-sm font-medium rounded-md ${isActive ? 'bg-blue-50 text-blue-700' : 'text-gray-600 hover:bg-gray-50 hover:text-black'}`}>• Pan Card History</NavLink>
                <NavLink to="/admin/credit-card-apply-request" className={({ isActive }) => `block px-3 py-2 text-sm font-medium rounded-md ${isActive ? 'bg-blue-50 text-blue-700' : 'text-gray-600 hover:bg-gray-50 hover:text-black'}`}>• Credit Card Apply Request</NavLink>
              </div>
            )}
          </div>
