            ...
            <div className="flex flex-col gap-4">
              <div className="flex justify-between items-center bg-slate-50 p-3.5 rounded-2xl">
                <div className="flex flex-col">
                  ...
                  <span className="text-slate-800 font-bold text-lg">498</span>
                </div>
                <div className="text-right flex flex-col">
                  <span className="text-emerald-500 font-bold bg-emerald-50 px-2 py-0.5 rounded-md text-xs">Active</span>
                </div>
              </div>
              <div className="flex justify-between items-center bg-slate-50 p-3.5 rounded-2xl">
                <div className="flex flex-col">
                ...
                <div className="text-right flex flex-col text-xs font-semibold text-slate-500">
                  <span className="text-slate-700">₹26k</span>
                  Comm.
                </div>
              </div>
            </div>
