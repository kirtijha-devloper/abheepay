...
import {
  SmartphoneNfc, Send, Wallet, Users, Network,
  ...
  return (
    <div className="space-y-8 animate-in fade-in duration-500">
      <div className="flex flex-col gap-1">
        ...
        <p className="text-slate-500 font-medium">Monitor your distibutors and high-level transactions.</p>
      </div>
        ...
        <div className="xl:col-span-1 space-y-8">
          ...
          <div className="rounded-3xl p-8 shadow-lg bg-gradient-to-br from-cyan-600 to-indigo-800 border border-cyan-500 relative overflow-hidden">
            ...
            <div className="relative z-10 flex flex-col gap-6">
              ...
              <div>
                <p className="text-cyan-100 text-sm font-medium tracking-wide">TOTAL NETWORK VOLUME</p>
                <h3 className="text-4xl font-extrabold text-white mt-1 tracking-tight">₹8.94M</h3>
                <p className="text-cyan-100 opacity-80 mt-2 text-sm">₹85,240 Comm. this month</p>
              </div>
          ...
          <div className="bg-white rounded-3xl p-6 shadow-sm border border-slate-100/60 flex flex-col gap-6">
            <div className="flex items-center justify-between">
              <h3 className="text-lg font-bold text-slate-800">Network Details</h3>
            ...
            <div className="flex flex-col gap-3">
              <div className="flex justify-between items-center bg-slate-50 p-3.5 rounded-2xl">
                <div className="flex flex-col">
                  ...
                  <span className="text-slate-800 font-bold text-lg">15</span>
                </div>
                <div className="text-right flex flex-col">
                  <span className="text-violet-600 font-bold bg-violet-50 px-2 py-0.5 rounded-md text-xs">12 Active</span>
                </div>
              </div>
              <div className="flex justify-between items-center bg-slate-50 p-3.5 rounded-2xl">
                <div className="flex flex-col">
                  <span className="text-slate-500 font-medium text-xs uppercase tracking-wider">Retailers</span>
                  <span className="text-slate-800 font-bold text-lg">245</span>
                </div>
              </div>
              <div className="flex justify-between items-center bg-slate-50 p-3.5 rounded-2xl">
                <div className="flex flex-col">
                  <span className="text-slate-500 font-medium text-xs uppercase tracking-wider">Total</span>
                  <span className="text-slate-800 font-bold text-lg">260</span>
                </div>
              </div>
            </div>
