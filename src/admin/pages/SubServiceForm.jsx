    ...
    return (
      <div className="max-w-2xl mx-auto mt-12 animate-in fade-in zoom-in duration-500">
        <div className="bg-white rounded-3xl p-10 shadow-lg border border-emerald-100 flex flex-col items-center text-center">
          ...
          <h2 className="text-3xl font-extrabold text-slate-800 mb-2">Request Processed!</h2>
          <p className="text-slate-500 mb-8">Your request for {config.title} has been submitted successfully. A reference ID has been generated.</p>

          <div className="bg-slate-50 rounded-2xl p-6 w-full text-left mb-8 space-y-3">
            <div className="flex justify-between text-sm">
              <span className="text-slate-500">Reference ID</span>
              <span className="font-bold text-slate-800">TXN{Math.floor(Math.random() * 100000000)}</span>
            </div>
            <div className="flex justify-between text-sm">
            ...
            {formData.amount && (
              <div className="flex justify-between text-sm">
                ...
                <span className="font-bold text-emerald-600">₹{formData.amount}</span>
              </div>
            )}
          </div>
